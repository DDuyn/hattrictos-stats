...
function TrophyIcon(props: { class?: string }) {
  return (
    <svg class={props.class} fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
...
function CogIcon(props: { class?: string }) {
  return (
    <svg class={props.class} fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
...
const BASE_ITEMS: NavItem[] = [
  ...
  { label: 'Competiciones', href: '/torneos', icon: TrophyIcon },
  { label: 'Equipos', href: '/equipos', icon: UsersIcon },
];

const STAFF_ITEMS: NavItem[] = [
  { label: 'Gestión Competiciones', href: '/admin/torneos', icon: CogIcon },
];
